 ...
 */
#define MPU9250_I2C_ADDR               0x69U

#define MPU9250_REG_INT_ENABLE   0x38U
#define MPU9250_RAW_RDY_EN       0x01U
...
#define MPU9250_SMPLRT_DIV_200HZ       0U

#define MPU9250_DLPF_CFG_41HZ          0x03U

#define MPU9250_GYRO_FS_500DPS         0x03U //2000dps haline getirildi

#define MPU9250_ACCEL_FS_4G            0x03U //16g haline getirildi.
 ...
 */
#define MPU9250_ACCEL_SCALE_4G         2048.0f //16g haline getirildi.
 ...
 */
#define MPU9250_GYRO_SCALE_500DPS      16.4f //2000dps haline getirildi
...
static uint8_t AK8963_Read(MPU9250_Data *data)
{
    uint8_t st1;
    uint8_t buffer[7];
    uint8_t st2;
...
uint8_t MPU9250_Init(I2C_HandleTypeDef *i2c_handle)
{
    ...
    /*
	 * MPU9250 Data Ready kesmesini (interrupt) aktif et.
	 * Bu sayede yeni veri geldiğinde sensör PB5 pinine bir sinyal (pulse) gönderecek.
	 */
	if(MPU9250_WriteRegister(MPU9250_REG_INT_ENABLE,
							 MPU9250_RAW_RDY_EN) == 0U)
	{
		return 0U;
	}

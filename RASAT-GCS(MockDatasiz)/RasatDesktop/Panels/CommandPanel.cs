...
namespace _10OcakRASAT.Panels
{
    ...
    public class CommandPanel : IPanelContent
    {
        ...
        public Control CreateControl()
        {
            ...
            mainLayout.RowStyles.Add(new RowStyle(SizeType.Percent, 20)); // ARAS Başlık ve Işıklar
            mainLayout.RowStyles.Add(new RowStyle(SizeType.Percent, 20)); // Ayrılma
            mainLayout.RowStyles.Add(new RowStyle(SizeType.Percent, 20)); // Paraşüt
            mainLayout.RowStyles.Add(new RowStyle(SizeType.Percent, 20)); // Gönder
            mainLayout.RowStyles.Add(new RowStyle(SizeType.Percent, 20)); // LED'ler
            ...
            arasContainer.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 25f));
            arasContainer.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 25f));
            arasContainer.RowStyles.Add(new RowStyle(SizeType.Absolute, 18f));
            arasContainer.RowStyles.Add(new RowStyle(SizeType.Percent, 100f));
            ...
            _light1 = new Panel { BackColor = Color.Lime, Margin = new Padding(4), Dock = DockStyle.Fill };
            _light2 = new Panel { BackColor = Color.Lime, Margin = new Padding(4), Dock = DockStyle.Fill };
            _light3 = new Panel { BackColor = Color.Lime, Margin = new Padding(4), Dock = DockStyle.Fill };
            _light4 = new Panel { BackColor = Color.Lime, Margin = new Padding(4), Dock = DockStyle.Fill };
            ...
            // === DİĞER BUTONLAR ===
            var btnManuel = CreateCompactButton("AYRILMA KOMUTU", Color.FromArgb(160, 40, 40));
            btnManuel.Click += (s, e) => ShowConfirmation("Manuel Ayrılma?", "Ayrılma", "AYRILMA");
            mainLayout.Controls.Add(btnManuel, 0, 1);

            var btnParachute = CreateCompactButton("ACİL PARAŞÜT", Color.FromArgb(180, 100, 0));
            btnParachute.Click += (s, e) => ShowConfirmation("Acil Paraşüt Açılsın mı?", "Paraşüt", "PARASUT");
            mainLayout.Controls.Add(btnParachute, 0, 2);

            var btnSend = CreateCompactButton("KOD GÖNDER", Color.FromArgb(0, 100, 80));
            btnSend.Click += BtnSend_Click;
            mainLayout.Controls.Add(btnSend, 0, 3);
            ...
            mainLayout.Controls.Add(ledPanel, 0, 4);
        ...
        private void UpdateLights(string errorCode)
        {
            ...
            {
                // STM32'den veriler ASCII karakteri ('1') olarak da gelebilir, Raw Byte (\x01) olarak da.
                // İki durumu da kapsıyoruz ki LED'ler kesinlikle kırmızıya dönsün.

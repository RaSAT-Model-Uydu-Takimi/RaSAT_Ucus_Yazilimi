...
typedef struct {
    ...
    float ref_ground_altitude_m; // Referans zemin yüksekliği
} SensorCalib_t;
 ...
 * İşlev:
 *   1. DataCenter rawValue değerlerini Sensor_Calib_t bias ve scale ile kalibre eder
 *   2. Birim çevirimi yapar (g→m/s², dps→rad/s)
 *   3. DataCenter calibratedValue alanlarını doldurur
 */
